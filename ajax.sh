curl 'http://mooc1.chaoxing.com/mycourse/studentstudyAjax' \
	-s \
  ...
  -H 'Origin: http://mooc1.chaoxing.com' \
  -H 'Referer: http://mooc1.chaoxing.com/mycourse/studentstudy?chapterId=154173237&courseId=204207140&clazzid=31024786&enc=df4e1faa403ae0f6285c990d3b0a730a' \
  ...
  --data-raw "courseId=${1}&clazzid=${2}&chapterId=${3}&cpi=${4}&verificationcode=" \
  --compressed \
  --insecure
